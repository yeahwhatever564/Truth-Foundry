  ...
  return (
    <main style={{ padding:'2rem', maxWidth:'1000px', margin:'0 auto' }}>
          ...
          <tbody>
            {data.map((vc, i) => (
              <tr key={i} style={{ background: i%2===0?'#111': '#222' }}>
                ...
                <td style={td}><span style={{color: vc.d3s >=70 ? '#ff4444': vc.d3s >=50 ? '#ffaa00' : '#44ff44'}}>{vc.d3s}</span></td>
                <td style={td}><span style={{color: vc.iis >=20 ? '#ff0000' : vc.iis >=10 ? '#ff8800' : '#00ff00'}}>{vc.iis}</span></td>
      ...
      <div style={{ textAlign:'center', marginTop:'4rem' }}>
        <a href="https://github.com/YOUR-USERNAME/YOUR-REPO" style={{ color:'#ff4444', fontSize:'underline' }}>
